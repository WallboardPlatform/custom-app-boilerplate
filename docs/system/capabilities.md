...
| Wayfinding routing | `WayfindingGraph`, explicit graph schema, native SVG location annotations, route/graph report | `wayfinding.md`; standard/step-free paths, disabled edges, legacy import audit, topology warnings |
