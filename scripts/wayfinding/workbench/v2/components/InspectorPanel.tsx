...
interface InspectorPanelProps {
	deliveryIssues: Accessor<WayfindingStudioIssue[]>;
	...
	projectIssues: Accessor<WayfindingStudioIssue[]>;
	...
	return (
		<aside class="right-panel panel-shell" aria-label="Inspector">
			...
			<div class="panel-scroll">
				...
				<Problems issues={props.projectIssues} store={props.store} />
			</div>
		</aside>
	);
};
