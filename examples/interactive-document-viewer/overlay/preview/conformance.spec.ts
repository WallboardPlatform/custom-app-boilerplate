...
registerEmptyStateConformance({
	...
	root: (page: Page): Locator => page.locator('[data-preview-id="interactive-document-viewer-root"]'),
	...
	message: (page: Page): Locator => page.locator('[data-preview-id="directory-empty"] strong'),
	viewing: 'near'
});
