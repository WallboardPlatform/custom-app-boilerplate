...
export default (config: ConfigValues): Settings => ({
	...
	keyboardLanguages: config.keyboardLanguages === 'hu' || config.keyboardLanguages === 'hu-en' ? config.keyboardLanguages : 'en',
	mutedTextColor: text(config.mutedTextColor, '#9caaa6'),
	onScreenKeyboard: boolean(config.onScreenKeyboard, true),
