...
registerEmptyStateConformance({
	...
	root: (page: Page): Locator => page.locator('[data-preview-id="veszprem-wayfinding-root"]'),
	...
	message: (page: Page): Locator => page.locator('[data-preview-id="destinations-empty"]'),
	viewing: 'near'
});
