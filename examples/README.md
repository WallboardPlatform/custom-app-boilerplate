...
| `wayfinding-kiosk` | Opt-in Studio mini-displayer harness, packaged synthetic `.wbmap`, 2D/3D exploration, animated 2D route preview, complete exploded 3D journey, camera, speech, and live destination availability | Full HD, 2D/3D, route preview, route journey, dark/light/custom, unavailable destination, long copy, live update, packaged runtime |
